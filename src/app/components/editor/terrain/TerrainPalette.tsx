      ...
      <div style={headerStyle}>
        ...
        <div style={rightToolsStyle}>
          <input
            ...
            placeholder="Search terrain: grass, water, dirt, asphalt, sand..."
            style={searchStyle}
          />
          <button type="button" onClick={() => clearAllDirectTerrainPaint()} style={clearButtonStyle}>
            Clear Terrain Paint
          </button>
        </div>
      </div>
...
const titleStyle: React.CSSProperties = { fontWeight: 900, color: "#252018" };
const subtitleStyle: React.CSSProperties = { fontWeight: 800, color: "#584c35", fontSize: "0.85rem", marginTop: 4 };
const rightToolsStyle: React.CSSProperties = { display: "grid", gap: 8 };
const searchStyle: React.CSSProperties = { border: "2px solid #252018", background: "#fff3a8", color: "#252018", padding: "9px 10px", fontWeight: 900 };
const clearButtonStyle: React.CSSProperties = { border: "2px solid #252018", background: "#ca4b36", color: "#fff8c8", padding: "9px 10px", cursor: "pointer", fontWeight: 900 };
const assetGridStyle: React.CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(96px, 1fr))", gap: 8, maxHeight: 420, overflow: "auto", padding: 2 };
const assetButtonStyle: React.CSSProperties = { color: "#252018", cursor: "pointer", padding: 7, display: "grid", gap: 5, justifyItems: "center", fontWeight: 900 };
const assetPreviewStyle: React.CSSProperties = { width: 48, height: 48, imageRendering: "pixelated" };
const assetLabelStyle: React.CSSProperties = { fontSize: "0.62rem", lineHeight: 1.05, textAlign: "center", maxHeight: 28, overflow: "hidden" };
